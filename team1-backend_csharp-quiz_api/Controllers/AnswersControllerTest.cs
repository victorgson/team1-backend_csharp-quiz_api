...
namespace team1_backend_csharp_quiz_api.Controllers
{
    ...
    [ApiController]
    public class AnswersControllerTest : ControllerBase
    {
        private readonly QuizDatabaseContext _context;

        public AnswersControllerTest(QuizDatabaseContext context)
        {
            _context = context;
        }

        // GET: api/AnswersControllerTest
        [HttpGet]
        ...
        // GET: api/AnswersControllerTest/5
        [HttpGet("{id}")]
        ...
        // PUT: api/AnswersControllerTest/5
        ...
        // POST: api/AnswersControllerTest
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        ...
        // DELETE: api/AnswersControllerTest/5
        [HttpDelete("{id}")]
